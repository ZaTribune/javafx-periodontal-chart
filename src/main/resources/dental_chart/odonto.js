...
function limitTextarea(textarea,maxLines,maxChar){
	...
	function drawVisualization18a(data18a) {
	  ...
	  function numberRangeMobility(campo){
		var dato=document.getElementById(campo).value;
		dato= parseInt(dato);
		//alert(dato);
		if(dato<(-3) || dato>3){
			alert("The mobility data must be between -3 and +3");
	  ...
	  function numberRangeMargin(campo){
		var dato=document.getElementById(campo).value;
		dato= parseInt(dato);
		//alert(dato);
		if(dato<(-9) || dato>9){
			alert("The gingival margin data must be between -9 and +9");
			document.getElementById(campo).value='0';
		}
...
$(document).ready(function(){
	...
	$('#m18, #m17, #m16, #m15, #m14, #m13, #m12, #m11').change(function(event) {
		numberRangeMobility($(this).attr('name'));
	});
	...
	$('#mg31-a, #mg31-b, #mg31-c').change(function(event) {
		getDefectos(); numberRangeMargin($(this).attr('name')); cargar31a();
	});
	...
	$('#mg33-a, #mg33-b, #mg33-c').change(function(event) {
		getDefectos(); numberRangeMargin($(this).attr('name')); cargar33a();
	});
	// Operations for "Margen gingivial" 34
	$('#mg34-a, #mg34-b, #mg34-c').change(function(event) {
		getDefectos(); numberRangeMargin($(this).attr('name')); cargar34a();
	});
	// Operations for "Margen gingivial" 35
	$('#mg35-a, #mg35-b, #mg35-c').change(function(event) {
		getDefectos(); numberRangeMargin($(this).attr('name')); cargar35a();
	});
	// Operations for "Margen gingivial" 36
	$('#mg36-a, #mg36-b, #mg36-c').change(function(event) {
		getDefectos(); numberRangeMargin($(this).attr('name')); cargar36a();
	});
	// Operations for "Margen gingivial" 37
	$('#mg37-a, #mg37-b, #mg37-c').change(function(event) {
		getDefectos(); numberRangeMargin($(this).attr('name')); cargar37a();
	});
	// Operations for "Margen gingivial" 38
	$('#mg38-a, #mg38-b, #mg38-c').change(function(event) {
		getDefectos(); numberRangeMargin($(this).attr('name')); cargar38a();
	});
	// ---------------------------------------------------------------------
	// ---------------------------------------------------------------------
	// Operations for "Profundidad Sondaje" 38a
	$('#ps38-a, #ps38-b, #ps38-c').change(function(event) {
		cargar38a();getDefectos();
	});
	// Operations for "Profundidad Sondaje" 37a
	$('#ps37-a, #ps37-b, #ps37-c').change(function(event) {
		cargar37a();getDefectos();
	});
	// Operations for "Profundidad Sondaje" 36a
	$('#ps36-a, #ps36-b, #ps36-c').change(function(event) {
		cargar36a();getDefectos();
	});
	// Operations for "Profundidad Sondaje" 35a
	$('#ps35-a, #ps35-b, #ps35-c').change(function(event) {
		cargar35a();getDefectos();
	});
	// Operations for "Profundidad Sondaje" 34a
	$('#ps34-a, #ps34-b, #ps34-c').change(function(event) {
		cargar34a();getDefectos();
	});
	// Operations for "Profundidad Sondaje" 33a
	$('#ps33-a, #ps33-b, #ps33-c').change(function(event) {
		cargar33a();getDefectos();
	});
	// Operations for "Profundidad Sondaje" 32a
	$('#ps32-a, #ps32-b, #ps32-c').change(function(event) {
		cargar32a();getDefectos();
	});
	// Operations for "Profundidad Sondaje" 31a
	$('#ps31-a, #ps31-b, #ps31-c').change(function(event) {
		cargar31a();getDefectos();
	});
	// ---------------------------------------------------------------------
});